...
while True:
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith(('.jpg', '.jpeg', '.png')):  # Kontrola, či ide o obrázok
            ...
            boxes, weights = hog.detectMultiScale(image, winStride=(1,1), padding=(8,8))
            ...
            cv2.waitKey(1000)  # Zobrazí obrázok po dobu 30 sekund
            # cv2.waitKey(0)
    ...
    time.sleep(5)  # Počkajte 30 sekund pred opätovným prechodom cez priečinok
